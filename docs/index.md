...
# Application
An application built from https://github.com/redhat-appstudio-mjf/codegen1-may7-2 will be stored in [quay.io/maysunfaisal/codegen1-may7-2](https://quay.io/maysunfaisal/codegen1-may7-2) and deployed through GitOps. This application is accessible on port **8501**.